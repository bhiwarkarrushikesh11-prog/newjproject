...
public class AddStudentAccount extends JFrame {
	...
	public AddStudentAccount() {
		...
		lblAddStudentAccount.setBounds(10, 11, 414, 34);
		...
		lblInstitution.setBounds(10, 163, 124, 14);
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String instName = textField_2.getText();

				if(name.isEmpty() || balanceText.isEmpty() || instName.isEmpty()) {
				...
				if(bal < 100) {
					JOptionPane.showMessageDialog(getComponent(0), "Minimum Balance 100", "Warning", JOptionPane.WARNING_MESSAGE);
					return;
				}
